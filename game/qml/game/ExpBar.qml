...
Item {
    ...
    ShaderEffect {
        ...
        fragmentShader: "
            ...
            void main() {
                ...
                highp vec4 color = vec4(1.0 - .01, .01, 0.0, 1.0);
    ...
    Item {
        ...
        ShaderEffect {
            ...
            void main() {
                lowp vec4 pix = texture2D(source, qt_TexCoord0);
                highp vec4 color = vec4(1.0 - .01, .01, 0.2, 1.0);
